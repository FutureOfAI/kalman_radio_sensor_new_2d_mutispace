...
clear all;
clc;
load('aj_16.mat');%linvelgyro125.mat  linveltest (7)  data (6)aj_1aj_1data (4)
...
position_2(1,l) = (pos(1,k)^2-pos(2,k)^2+c_1^2+(tri_high_2^2-tri_high_1^2)) / (2*c_1);
position_2(2,l) = ((pos(1,k)^2-pos(4,k)^2+(tri_high_4^2-tri_high_1^2)+(position_2(1,l)-a_1)^2)/(2*b_1) + (b_1/2) - ((pos(1,k)^2-pos(2,k)^2+c_1^2+(tri_high_2^2-tri_high_1^2))^2)/(8*b_1*(c_1^2)));
...
c_1 = y_anchor_2 - y_anchor_1;
position_2(1,l) = ((pos(1,k)^2-pos(2,k)^2+c_1^2)+(tri_high_2^2-tri_high_1^2)) / (2*c_1);%+(tri_high_2^2-tri_high_1^2)
position_2(2,l) = ((pos(1,k)^2-pos(3,k)^2+(tri_high_3^2-tri_high_1^2)+(position_2(1,l)-a_1)^2)/(2*b_1) + (b_1/2) - ((pos(1,k)^2-pos(2,k)^2+c_1^2+(tri_high_2^2-tri_high_1^2))^2)/(8*b_1*(c_1^2)));%+(tri_high_2^2-tri_high_1^2)
position_2(3,l) = sqrt(pos(1,k)^2-position_2(1,l)^2-position_2(2,l)^2);
position_2(3,l) = z_anchor_1 - position_2(3,l);
position_2(1,l) = position_2(1,l) + y_anchor_1;
position_2(2,l) = position_2(2,l) + x_anchor_1;
...
position_2(1,l) = ((pos(3,k)^2-pos(4,k)^2+c_1^2)+(tri_high_4^2-tri_high_3^2)) / (2*c_1);
position_2(2,l) = ((pos(3,k)^2-pos(2,k)^2+(tri_high_2^2-tri_high_3^2)+(position_2(1,l)-a_1)^2)/(2*b_1) + (b_1/2) - ((pos(3,k)^2-pos(4,k)^2+c_1^2+(tri_high_4^2-tri_high_3^2))^2)/(8*b_1*(c_1^2)));
...
c_1 = y_anchor_4 - y_anchor_3;
position_2(1,l) = ((pos(3,k)^2-pos(4,k)^2+c_1^2)+(tri_high_4^2-tri_high_3^2)) / (2*c_1);
position_2(2,l) = ((pos(3,k)^2-pos(1,k)^2+(tri_high_1^2-tri_high_3^2)+(position_2(1,l)-a_1)^2)/(2*b_1) + (b_1/2) - ((pos(3,k)^2-pos(4,k)^2+c_1^2+(tri_high_4^2-tri_high_3^2))^2)/(8*b_1*(c_1^2)));
position_2(3,l) = sqrt(pos(3,k)^2-position_2(1,l)^2-position_2(2,l)^2);
position_2(3,l) = z_anchor_3 - position_2(3,l);
position_2(1,l) = position_2(1,l) + y_anchor_3;
position_2(2,l) = position_2(2,l) + x_anchor_3;
...
mean_LS = mean(abs(mean_1(1,count/2:count-1)));
mean_Tri = mean(abs(mean_2(1,count/2:count-1)));
...
figure (17)
% % % paper use test
% plot(position_2(1,:),position_2(2,:),'MarkerSize',13,'LineWidth',1)%position_2(1,:),position_2(2,:),'g.',ypm_Nh(1:3991),xpm_Nh(1:3991)
% hold on
% plot(position_2(1,1),position_2(2,1),'rdiamond',position_2(1,3991),position_2(2,3991),'rx',y_5,x_5,'--r','MarkerSize',13,'LineWidth',2)
% % % plot(ypm_Nh(1),xpm_Nh(1),'rdiamond',ypm_Nh(3991),xpm_Nh(3991),'rx','MarkerSize',13,'LineWidth',2)
% legend('TRI','Start point','End point','Reference path');%EKF dynamic
% grid
% axis([6 7.5 4.3 5])

%%  point 5/17
plot(position_2(1,:),position_2(2,:),'MarkerSize',9,'LineWidth',1)%,position(1,:),position(2,:)'g',position_2(1,:),position_2(2,:)
hold on
plot(position_2(1,1),position_2(2,1),'rdiamond',position_2(1,3991),position_2(2,3991),'rx','MarkerSize',9,'LineWidth',2)%position_2(1,1),position_2(2,1)
hold on
legend('TRI','Start point','End point','Anchor');%'Reference path','Least square','Anchor',dynamic
hold on
grid
