...
mean_KF = mean(abs(mean_3(1,2000:count-9)));
...
% plot(position(1,:),position(2,:),'g.',ypm_Nh(1:3991),xpm_Nh(1:3991),'r')%
% hold on
% legend('TRI','EKF');
% hold on
%  
...
%% line straight 5/17
% % % paper use test
% plot(ypm_Nh(1:3991),xpm_Nh(1:3991),'MarkerSize',13,'LineWidth',1)%position_2(1,:),position_2(2,:),'g.',ypm_Nh(1:3991),xpm_Nh(1:3991)
% hold on
% plot(ypm_Nh(1),xpm_Nh(1),'rdiamond',ypm_Nh(3991),xpm_Nh(3991),'rx',y_5,x_5,'--r','MarkerSize',13,'LineWidth',2)
% % % plot(ypm_Nh(1),xpm_Nh(1),'rdiamond',ypm_Nh(3991),xpm_Nh(3991),'rx','MarkerSize',13,'LineWidth',2)
% legend('EKF static','Start point','End point','Reference path');%EKF dynamic
...
% hold on
% legend('EKF static','Start point','End point','Reference path');%'Reference path','Least square','Anchor','LS',
% hold on
...
%%   (5/17) circle
% plot(ypm_Nh(1:1350),xpm_Nh(1:1350),'MarkerSize',9,'LineWidth',1)%ypm_Nh(1:1350),xpm_Nh(1:1350)
% hold on
% plot(ypm_Nh(1),xpm_Nh(1),'rdiamond',ypm_Nh(1350),xpm_Nh(1350),'rx','MarkerSize',9,'LineWidth',2)%position_2(1,1),position_2(2,1)
% hold on
...
% hold on
% legend('EKF dynamic','Start point','End point','Anchor');%'Reference path','Least square','Anchor',
% hold on
...
% hold on
%%  point 5/17
plot(ypm_Nh(1:3991),xpm_Nh(1:3991),'MarkerSize',9,'LineWidth',1)%,position(1,:),position(2,:)'g',position_2(1,:),position_2(2,:)
hold on
plot(ypm_Nh(1),xpm_Nh(1),'rdiamond',ypm_Nh(3991),xpm_Nh(3991),'rx','MarkerSize',9,'LineWidth',2)%position_2(1,1),position_2(2,1)
hold on
legend('EKF dynamic','Start point','End point','Anchor');%'Reference path','Least square','Anchor',dynamic
hold on
...
%
figure (10)
subplot(3,1,1), plot(t0(n1:n2),bx_h(n1:n2),'r');         
xlabel('Time in seconds');ylabel('Accel bias along-axis in g');
subplot(3,1,2), plot(t0(n1:n2),by_h(n1:n2),'r');         
xlabel('Time in seconds');ylabel('Accel bias perp-axis in g');
subplot(3,1,3), 
plot(t0(n1:n2),bz_h(n1:n2)*r2d,'r');
...
% subplot(311)
% subplot(211)
% plot(t0(n1:n2),xpm_Nh(n1:n2),'MarkerSize',13,'LineWidth',1)%xpm_Nh(n1:n2)
% xlabel('Time in seconds')
% ylabel('X positioning in m')
% axis([0 40 4.5 4.9])
% legend('X');
% subplot(212)
% plot(t0(n1:n2),ypm_Nh(n1:n2),'MarkerSize',13,'LineWidth',1)%ypm_Nh(n1:n2)
% xlabel('Time in seconds')
...
% subplot(311)
subplot(211)
plot(t0(n1:n2),xpm_Nh(n1:n2),'MarkerSize',13,'LineWidth',1)%position_2(2,n1:n2)
xlabel('Time in seconds')
ylabel('X positioning in m')
% axis([0 13.5 -1 6]) %circle
% axis([0 40 0 10]) %other trajectory
axis([0 40 4.53 4.8])%point
% axis([0 40 -1 6]) %square

legend('X');
subplot(212)
plot(t0(n1:n2),ypm_Nh(n1:n2),'MarkerSize',13,'LineWidth',1)%position_2(1,n1:n2)
xlabel('Time in seconds')
ylabel('Y positioning in m')
% axis([0 13.5 2 6]) %circle
% axis([0 40 3 7]) %other trajectory
axis([0 40 6.65 6.85])%point
% axis([0 40 2 6]) %square
legend('Y');
