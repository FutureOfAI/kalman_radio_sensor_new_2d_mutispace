...
%=====================================================
% (1) positions of four ratio sensors's positions
%================================
xr1 = 0;% in meter
yr1 = 50;% in meter
xr2 = 0;
...
%=========================================================
[R1m,R2m,R3m,R4m,nvx_r,nvy_r] = radio_sensor_m_4(xr1,yr1,xr2,yr2,xr3,yr3,xr4,yr4,x_p_N,y_p_N,h,sig_x_r,sig_y_r,n,m);%6-state, 4 radio sensors
%=========================================================
...
% Ready for filter updates
    ...
    %H,F_z,
    [H,R,R1m_h,R2m_h,R3m_h,R4m_h]=radio_discrete_4_EKF(xr1,yr1,xr2,yr2,xr3,yr3,xr4,yr4,xpm_Nh,ypm_Nh,sig_x_r,sig_y_r,h,k);%6-state
%   
    [P00_z,K_z,z_update]=Kalman_Filter_update4_radio(xz_h,P00_z,R1m,R2m,R3m,R4m,H,R,R1m_h,R2m_h,R3m_h,R4m_h,k);%6-state
