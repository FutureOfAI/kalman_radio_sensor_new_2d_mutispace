function [xpm_Nh,ypm_Nh,xvm_Nh,yvm_Nh,xam_Nh,yam_Nh,axm_h,aym_h,by_h,bx_h,wzm_h,psi_h,bz_h]=initial_estimate_value8_radio(m,x_a_N,y_a_N,x_v_N,y_v_N,x_p_N,y_p_N,wzm,axm,aym,psi,d2r,xverr,yverr,xperr,yperr,xaerr,yaerr,psierr,position_y,position_x,bz0)
%
axm_h=zeros(m);
aym_h=zeros(m);
by_h=zeros(m);
...
wzm_h(1)=wzm(1);
psi_h(1)=0*d2r;%psi(1) ;%+ psierr*rand*d2r;-180
bz_h(1)=bz0;
% bz_h(1)=-4.37*d2r;
