...
%
figure(4)
subplot(2,1,1), plot(t0(n1:n2),x_p_N(n1:n2)-xpm_Nh(n1:n2)','r');         
xlabel('Time in seconds');ylabel('x-axis position err in m');
subplot(2,1,2), plot(t0(n1:n2),y_p_N(n1:n2)-ypm_Nh(n1:n2)','r');         
xlabel('Time in seconds');ylabel('y-axis position err in m');
% 
